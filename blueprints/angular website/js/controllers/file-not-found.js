define(['app'], function (app) {
    ...
    app.controller('file-not-found', function ($scope, siteShell, searchEngineOptimiser) {
        ...
        $scope.message = 'Looks like that pesky file you were after isn\'t about, best look at something else so you make good use of your valuable procrastination time!!!';
    });
});
